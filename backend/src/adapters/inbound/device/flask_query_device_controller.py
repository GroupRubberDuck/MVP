...
from core.ports.inbound.device.get_device_use_case import (
    GetDeviceDetailCommand,
    GetDeviceDetailUseCase,
)
from core.ports.inbound.compliance_standard.get_compliance_standard_use_case import (
    ...
    def register_routes(self, blueprint: Blueprint) -> None:
        ...
        def get_device_list():
            ...
            return render_template(
                "layouts/device/device_list.html", devices=device_list_dto
            )
        ...
        def get_device_detail(device_id):
            ...
            try:
                ...
                standard = (
                    self._get_compliance_standard_use_case.get_compliance_standard(
        ...
        def edit_device_page(device_id):
            ...
            try:
                device = self._get_device_detail_use_case.get_device_detail(command)
                return render_template(
                    "layouts/device/edit_device.html",
                    device=DeviceDetailDTO(
                        device_id=device.id,
                        name=device.name,
                        os=device.os,
