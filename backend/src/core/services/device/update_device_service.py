...
from core.ports.inbound.device.update_device_use_case import UpdateDeviceCommand, UpdateDeviceUseCase
...
class UpdateDeviceService(UpdateDeviceUseCase):
    def __init__(self, find_device_port: FindDevicePort, save_device_port: SaveDevicePort) -> None:
