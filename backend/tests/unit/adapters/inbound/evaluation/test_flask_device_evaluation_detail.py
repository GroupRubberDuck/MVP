...
def create_mock_validation_error() -> ValidationError:
    ...
    return ValidationError.from_exception_data(
        "GetDeviceEvaluationDetailCommand", line_errors=[]
    )
...
class TestFlaskDeviceEvaluationDetailController:
    @patch(
        "adapters.inbound.evaluation.evaluation_detail.flask_device_evaluation_detail_controller.render_template"
    )
    ...
    @patch(
        "adapters.inbound.evaluation.evaluation_detail.flask_device_evaluation_detail_controller.GetDeviceEvaluationDetailCommand"
    )
    ...
    def test_ritorna_404_su_fallimento_use_case(
        ...
        mock_use_case.get_device_evaluation_detail.side_effect = (
            GetEvaluationDetailFailure("Dispositivo d1 non trovato")
        )
